...
If you are conducting research on HRnV or use HRnV-Calc software (HRnV-Calc tool is developed based on the PhysioNet Cardiovascular Signal Toolbox), please cite the following three articles:
